...
\begin{itemize}
\item Diseño de algoritmo para el posicionamiento de modelos anatómicos desde la posición en la que fueron modelados hasta cualquier posición requerida.
\\
%\todo{no puede ir en pasado son objetivos!!!!. Escríbelos como tales}
Se propone una técnica que permita transformar los modelos anatómicos de pacientes virtuales que originalmente se encuentran \new{en una postura diferente a la posición necesaria para el entrenamiento del procedimiento médico}.%\todo{desde la coma suana raro}. 
...
\new{Con el fin de demostrar que el algoritmo propuesto pueda ser utilizado en el entrenamiento médico, este será incorporado en dos tipos de aplicaciones de \ac{RV}.  En el primer caso, el algoritmo demostrará que puede adaptar la postura de un modelo anatómico que será utilizada por el simulador, teniendo en cuenta que el modelo pueda estar incompleto o no se disponga del comportamiento mecánico de los diferentes tejidos. En el segundo ejemplo, el algoritmo mostrará su capacidad interactiva al ser incluido en un simulador que permitirá al usuario modificar la postura del paciente virtual en tiempo real debido a las exigencias del procedimiento.} 
...
\new{En radiología diagnóstica, el médico debe posicionar al paciente de manera que la región anatómica objetivo de estudio sea adecuadamente capturada. El simulador permitirá entrenar las proyecciones radiográficas sin ningún riesgo para el paciente o el usuario. El algoritmo propuesto permite modificar la posición de un paciente virtual interactivamente, permitiendo comprobar distintas proyecciones y obtener imágenes de rayos X simultáneamente. Este simulador, podrá ser usado por profesores o estudiantes de radiología como una herramienta adicional a los libros de texto.}
\end{itemize}
